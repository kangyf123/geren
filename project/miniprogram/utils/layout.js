class Layouter {
  ...
  getSize(totalUser) {
    ...
    let videoContainerHeight = this.containerHeight;
    let videoContainerWidth = this.containerWidth;
    let subView_w = videoContainerWidth / 750 * 186;
    let subView_h = videoContainerWidth / 750 * 170;
    let subView_p = videoContainerWidth / 750 * 2;
    let subView = videoContainerHeight - videoContainerWidth / 750 * 130 - subView_h;
    switch (totalUser) {
      case 0:
        return [];
      case 1:
